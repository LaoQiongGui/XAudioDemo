...
enum DISPID_SpeechRecoContextEvents
	...
	DISPID_SRCEBargeIn	= ( DISPID_SRCEEnginePrivate + 1 ) ,
	DISPID_SRCETone	= ( DISPID_SRCEBargeIn + 1 ) 
...
EXTERN_C const IID IID_ISpeechRecoResult2;
    ...
    MIDL_INTERFACE("8F0A246D-D3C8-45DE-8657-04290C458C3C")
...
const BSTR SpeechRegistryUserRoot	=	L"HKEY_CURRENT_USER\SOFTWARE\Microsoft\Speech Server\v11.0";

const BSTR SpeechRegistryLocalMachineRoot	=	L"HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Speech Server\v11.0";

const BSTR SpeechCategoryAudioOut	=	L"HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Speech Server\v11.0\AudioOutput";

const BSTR SpeechCategoryAudioIn	=	L"HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Speech Server\v11.0\AudioInput";

const BSTR SpeechCategoryVoices	=	L"HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Speech Server\v11.0\Voices";

const BSTR SpeechCategoryRecognizers	=	L"HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Speech Server\v11.0\Recognizers";

const BSTR SpeechCategoryAppLexicons	=	L"HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Speech Server\v11.0\AppLexicons";

const BSTR SpeechCategoryPhoneConverters	=	L"HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Speech Server\v11.0\PhoneConverters";

const BSTR SpeechCategoryRecoProfiles	=	L"HKEY_CURRENT_USER\SOFTWARE\Microsoft\Speech Server\v11.0\RecoProfiles";

const BSTR SpeechTokenIdUserLexicon	=	L"HKEY_CURRENT_USER\SOFTWARE\Microsoft\Speech Server\v11.0\CurrentUserLexicon";
...
class DECLSPEC_UUID("fb684fa3-7b22-41dc-b543-9da82b4f34da")
...
class DECLSPEC_UUID("a8a9c3ca-788d-4c3b-b097-aeb40a455f45")
SpPhraseInfoBuilder;
#endif
...
class DECLSPEC_UUID("dab165fc-9fb1-49fb-bec8-c4de11429779")
SpAudioFormat;
#endif
...
class DECLSPEC_UUID("aa0c21b3-6cb2-489c-a8b0-b42445e67af4")
SpWaveFormatEx;
#endif
...
class DECLSPEC_UUID("045ec862-a42b-45f2-88ab-070084a21e99")
SpInProcRecoContext;
#endif
...
class DECLSPEC_UUID("2b1db6a9-f27f-4557-b29f-f64842cd8fc3")
SpCustomStream;
#endif
...
class DECLSPEC_UUID("3346ef73-0e05-4907-81ac-1f3547da6ffe")
SpFileStream;
#endif
...
class DECLSPEC_UUID("499aa45f-7162-4848-a6ad-f37cca8af61e")
SpMemoryStream;
#endif
